...
(async () => {
    ...
    const executablePath = path.resolve(__dirname, 'ms-playwright', 'chromium-1169', 'chrome-win', 'chrome.exe');
    ...
    for (const row of rows) {
        ...
        // Ví dụ gọi hàm thao tác, bạn chỉnh lại theo nhu cầu
        ...
        // Nếu bạn chạy thành công, tăng biến totalRuns
        totalRuns++;
    }
